...
**Recipes** | A basic HTML website listing recipes.

## Technologies & Tools
* **Languages:** HTML5, CSS3, JavaScript
* **Tools:** Git, GitHub, VS Code, Linux (CLI)
* **Operating System:** Windows (via Git Bash)

## Key Learnings
* **Command Line:** Navigating the file system and manipulating files.
* **Git:** Version control, branching, and committing.
* **HTML/CSS:** Structure, semantics, Flexbox, and CSS Grid.
